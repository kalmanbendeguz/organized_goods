...
class NewRecipeDialogFragment : DialogFragment(), View.OnClickListener, RecipeIngredientAdapter.RecipeIngredientClickListener {
    ...
    interface NewRecipeDialogListener {
        fun onRecipeCreated(newRecipe: Recipe, newIngredients: List<Ingredient>)
    }
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        return AlertDialog.Builder(requireContext())
            ...
            .setPositiveButton("OK"){ _, _ ->
                 if (isValid()){
                     listener.onRecipeCreated(getRecipe(), getIngredients())
                 }
            }
